...
declare class GraphAnalysis<Nodes, GraphJSON = any[]> {
   ...
   */
  constructor({ graph, nodes }: { graph: cytoscape.ElementDefinition[]; nodes: Map<string, DependencyNodes> });
  /**
 ...
 *        Dependency graph
 */
declare function processInheritDoc({
  logger,
  dependencies,
}: {
